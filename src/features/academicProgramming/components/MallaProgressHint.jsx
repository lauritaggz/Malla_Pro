...
export default function MallaProgressHint({ forceShow = false }) {
  ...
  return (
    <div
      role="status"
      className="mb-5 rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-900 dark:text-amber-100"
    >
      <div className="flex items-start gap-3">
        <AlertTriangle className="h-5 w-5 shrink-0 text-amber-600 dark:text-amber-400 mt-0.5" />
        <div className="flex-1 min-w-0 space-y-1">
          <p className="font-bold text-amber-800 dark:text-amber-200 text-[13px]">
            Marca tus ramos en la malla antes de continuar
          </p>
          <p className="text-[12px] sm:text-[13px] leading-relaxed text-amber-900/90 dark:text-amber-100/85">
